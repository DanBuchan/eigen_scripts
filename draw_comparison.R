...
p1<-ggplot(comparison_data, aes(x=Top, y=Class, group=Method, fill=Method))+geom_bar(stat="identity", position="dodge")+scale_fill_brewer(palette='Blues')+scale_colour_brewer(palette='Blues')+ggtitle("Comparison of Class Recognition Performance")+ylab("TPR")+xlab("Top X")+theme(panel.background=element_blank(),plot.background=element_blank(),plot.title= element_text(hjust=0.5),text=element_text(size=25))
p2<-ggplot(comparison_data, aes(x=Top, y=Fold, group=Method, fill=Method))+geom_bar(stat="identity", position="dodge")+scale_fill_brewer(palette='Blues')+scale_colour_brewer(palette='Blues')+ggtitle("Superfamily and family hits excluded")+ylab("TPR")+xlab("Top X")+theme(panel.background=element_blank(),plot.background=element_blank(),plot.title= element_text(hjust=0.5),text=element_text(size=25))

p3<-ggplot(sf_comparison_data, aes(x=Top, y=Class, group=Method, fill=Method))+geom_bar(stat="identity", position="dodge")+scale_fill_brewer(palette='Blues')+scale_colour_brewer(palette='Blues')+ggtitle("Comparison of Class Recognition Performance")+ylab("TPR")+xlab("Top X")+theme(panel.background=element_blank(),plot.background=element_blank(),plot.title= element_text(hjust=0.5),text=element_text(size=25))
p4<-ggplot(sf_comparison_data, aes(x=Top, y=Fold, group=Method, fill=Method))+geom_bar(stat="identity", position="dodge", aes(colour = Method))+scale_fill_brewer(palette='Blues')+scale_colour_brewer(palette='Blues')+ggtitle("Family hits excluded")+ylab("TPR")+xlab("Top X")+theme(panel.background=element_blank(),plot.background=element_blank(), plot.title= element_text(hjust=0.5),text=element_text(size=25))
