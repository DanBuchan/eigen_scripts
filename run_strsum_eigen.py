...
def run_strsum_eigen(file):
    ...
    # print(pdb)
    # print(scop_dir_id)
    scop_file = "/scratch0/NOT_BACKED_UP/dbuchan/pdbstyle-1.75/"+scop_dir_id+"/"+pdb+".ent"
    if os.path.isfile(scop_file):
        call(["dssp", "-i", scop_file, "-o", "/cs/research/bioinf/home1/green/dbuchan/archive0/eigen_thread/dssp_overlap/"+pdb+".dssp"])
    else:
        print("MISSING: "+pdb)
    dssp = pdb+".dssp"
    tdb = pdb+".tdb"
    eig = pdb+".eig"
    dssp_dir = "/cs/research/bioinf/home1/green/dbuchan/archive0/eigen_thread/dssp_overlap/"
    thread_dir = "/cs/research/bioinf/home1/green/dbuchan/archive0/eigen_thread/et_overlap/"
    print(pdb+" > "+dssp)
